        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("boleta_servicios", "Boleta de servicios"),
                            ("boleta_exenta", "Boleta exenta"),
                            ("factura", "Factura"),
                            ("otro", "Otro"),
                        ],
                        default="boleta_servicios",
                        max_length=30,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "estado",
                    models.CharField(
                        choices=[("consumido", "Consumido"), ("pendiente", "Pendiente"), ("deuda", "Deuda")],
                        default="pendiente",
                        max_length=20,
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["persona", "clase_fecha"], name="finanzas_at_persona_4a6041_idx"),
                    models.Index(fields=["estado", "clase_fecha"], name="finanzas_at_estado_041e5c_idx"),
                ],
            },
        ),
        migrations.AddIndex(
